class AjaxModalRails::InstallGenerator < Rails::Generators::Base
  ...
  class_option :application_layout, type: "string", default: "app/views/layout/application.html.erb", desc: "Specify a custom layout install target"
  ...
  def install_application_layout
    insert_into_file options.layout, "    <cable-modal></cable-modal>\n", before: "</body>"
  end

  def install_javascript
    append_to_file "app/assets/javascripts/application.js", File.read(javascript_template)
  end

  def install_modal_layout
